...
def eval_result(complete_predict_root_path,truth_ss_root_path,result_save_path):
    ...
    result_df.to_csv(os.path.join(result_save_path, f'bpRNA_new_result_ufold_evaluation.csv'), index=False, header=True)
...
def main():
    ...
    predict_result_path='/local4/fyf/TEST/UFold/results/predict_result/sub_predict'
    ...
    model_eval_all_test(contact_net,test_generator,predict_result_path)
    
    structure_combine(predict_result_path,truth_ss_root_path ,complete_predict_root_path)
